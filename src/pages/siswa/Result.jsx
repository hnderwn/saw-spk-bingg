                  ...
                  <div className="flex bg-gray-100 p-1 rounded-lg">
                    <button
                      ...
                      className={`px-3 py-1 text-xs font-medium rounded-md transition-colors ${
                        explanationLang === 'en' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
                      English
                    </button>
                    <button
                      ...
                      className={`px-3 py-1 text-xs font-medium rounded-md transition-colors ${
                        explanationLang === 'id' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
                      Indonesia
                    </button>
                          ...
                          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mt-4">
                            <div className="flex items-center mb-2">
                              ...
                              <h4 className="font-bold text-blue-900">
                                Pembahasan ({explanationLang === 'en' ? 'English' : 'Indonesia'})
                              </h4>
                            </div>
                            <p className="text-blue-800 text-sm whitespace-pre-wrap">
                              {explanationLang === 'id' 
                                ? (item.explanation_bahasa || "Maaf, penjelasan bahasa Indonesia belum tersedia untuk soal ini.") 
            ...
            <div className="bg-white rounded-lg w-full max-w-md p-6">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                <p className="text-sm text-yellow-800">
                  Sistem mendeteksi skor {selectedPracticeCategory.category} Anda masih perlu ditingkatkan.
                </p>
              </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-medium text-gray-900 capitalize">
                          {category === 'vocab' ? '(20%) Vocab - Kosakata' : 
                           category === 'grammar' ? '(25%) Grammar - Tata Bahasa' :
                           category === 'reading' ? '(25%) Reading - Membaca' :
                           category === 'cloze' ? '(30%) Cloze - Rumpang' : category}
                        </h3>
